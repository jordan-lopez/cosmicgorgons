        ...
        <div class="modal-content no-r ">
            ...
            <form id="frm-delete-blog" method="post">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" id="btn-delete-blog" class="btn btn-primary">Delete</button>
                </div>
            </form>
        </div>
    </div>
...
@endsection
@section('scripts')
<script src="{{ asset('/js/pages/delete_blog.js') }}"></script>
<script>
    $('#tbl-blog').DataTable({
        "ajax": {
            url: "blog-show",
